...
/**
 * Base class that represents a row from the 'turma' table.
 *
 * 
 *
 * @package    propel.generator.model.model.Base
 */
abstract class Turma implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\model\\model\\Map\\TurmaTableMap';
    ...
    /**
     * The value for the sq_turma field.
     * 
     * @var        int
     */
    protected $sq_turma;
    ...
    /**
     * The value for the id_modalidade field.
     * 
     * @var        int
     */
    ...
    /**
     * Initializes internal state of model\model\Base\Turma object.
     */
    ...
    /**
     * Compares this with another <code>Turma</code> instance.  If
     * <code>obj</code> is an instance of <code>Turma</code>, delegates to
     * <code>equals(Turma)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Turma The current object, for fluid interface
     */
    ...
    /**
     * Get the [sq_turma] column value.
     * 
     * @return int
     */
    public function getSqTurma()
    {
        return $this->sq_turma;
    }

    /**
     * Get the [optionally formatted] temporal [horario] column value.
     * 
     *
     ...
     */
    public function getHorario($format = NULL)
    {
        if ($format === null) {
            return $this->horario;
        } else {
            return $this->horario instanceof \DateTimeInterface ? $this->horario->format($format) : null;
        }
    }
    ...
    /**
     * Get the [id_modalidade] column value.
     * 
     * @return int
     */
    ...
    /**
     * Set the value of [sq_turma] column.
     * 
     * @param int $v new value
     * @return $this|\model\model\Turma The current object (for fluent API support)
     */
    public function setSqTurma($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->sq_turma !== $v) {
            $this->sq_turma = $v;
            $this->modifiedColumns[TurmaTableMap::COL_SQ_TURMA] = true;
        }
    ...
    /**
     * Sets the value of [horario] column to a normalized version of the date/time value specified.
     * 
    ...
    public function setHorario($v)
    {
        ...
        if ($this->horario !== null || $dt !== null) {
            if ($this->horario === null || $dt === null || $dt->format("H:i:s.u") !== $this->horario->format("H:i:s.u")) {
                $this->horario = $dt === null ? null : clone $dt;
                $this->modifiedColumns[TurmaTableMap::COL_HORARIO] = true;
            }
    ...
    public function setSqPessoa($v)
    {
        ...
        if ($this->sq_pessoa !== $v) {
            $this->sq_pessoa = $v;
            $this->modifiedColumns[TurmaTableMap::COL_SQ_PESSOA] = true;
        }

        if ($this->aPessoa !== null && $this->aPessoa->getSqPessoa() !== $v) {
            $this->aPessoa = null;
        }
    ...
    /**
     * Set the value of [id_modalidade] column.
     * 
     * @param int $v new value
     * @return $this|\model\model\Turma The current object (for fluent API support)
     */
    public function setIdModalidade($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_modalidade !== $v) {
            $this->id_modalidade = $v;
            $this->modifiedColumns[TurmaTableMap::COL_ID_MODALIDADE] = true;
        }

        if ($this->aModalidade !== null && $this->aModalidade->getIdModalidade() !== $v) {
            $this->aModalidade = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TurmaTableMap::translateFieldName('SqTurma', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sq_turma = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TurmaTableMap::translateFieldName('Horario', TableMap::TYPE_PHPNAME, $indexType)];
            $this->horario = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TurmaTableMap::translateFieldName('SqPessoa', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sq_pessoa = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TurmaTableMap::translateFieldName('IdModalidade', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_modalidade = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = TurmaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\model\\model\\Turma'), 0, $e);
        }
    }
    ...
    {
        if ($this->aPessoa !== null && $this->sq_pessoa !== $this->aPessoa->getSqPessoa()) {
            $this->aPessoa = null;
        }
        if ($this->aModalidade !== null && $this->id_modalidade !== $this->aModalidade->getIdModalidade()) {
            $this->aModalidade = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTurmaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTurmaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TurmaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aModalidade !== null) {
                if ($this->aModalidade->isModified() || $this->aModalidade->isNew()) {
                    $affectedRows += $this->aModalidade->save($con);
                }
                $this->setModalidade($this->aModalidade);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TurmaTableMap::COL_SQ_TURMA] = true;
        if (null !== $this->sq_turma) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TurmaTableMap::COL_SQ_TURMA . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TurmaTableMap::COL_SQ_TURMA)) {
            $modifiedColumns[':p' . $index++]  = 'SQ_TURMA';
        }
        if ($this->isColumnModified(TurmaTableMap::COL_HORARIO)) {
            $modifiedColumns[':p' . $index++]  = 'HORARIO';
        }
        if ($this->isColumnModified(TurmaTableMap::COL_SQ_PESSOA)) {
            $modifiedColumns[':p' . $index++]  = 'SQ_PESSOA';
        }
        if ($this->isColumnModified(TurmaTableMap::COL_ID_MODALIDADE)) {
            $modifiedColumns[':p' . $index++]  = 'ID_MODALIDADE';
        }

        $sql = sprintf(
            'INSERT INTO turma (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'SQ_TURMA':                        
                        $stmt->bindValue($identifier, $this->sq_turma, PDO::PARAM_INT);
                        break;
                    case 'HORARIO':                        
                        $stmt->bindValue($identifier, $this->horario ? $this->horario->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'SQ_PESSOA':                        
                        $stmt->bindValue($identifier, $this->sq_pessoa, PDO::PARAM_INT);
                        break;
                    case 'ID_MODALIDADE':                        
                        $stmt->bindValue($identifier, $this->id_modalidade, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = TurmaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Turma'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Turma'][$this->hashCode()] = true;
        $keys = TurmaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSqTurma(),
            $keys[1] => $this->getHorario(),
            $keys[2] => $this->getSqPessoa(),
            $keys[3] => $this->getIdModalidade(),
        );
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aModalidade) {
                ...
                $result[$key] = $this->aModalidade->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setSqTurma($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setHorario($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setSqPessoa($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setIdModalidade($arr[$keys[3]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\model\model\Turma The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(TurmaTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TurmaTableMap::COL_SQ_TURMA)) {
            $criteria->add(TurmaTableMap::COL_SQ_TURMA, $this->sq_turma);
        }
        if ($this->isColumnModified(TurmaTableMap::COL_HORARIO)) {
            $criteria->add(TurmaTableMap::COL_HORARIO, $this->horario);
        }
        if ($this->isColumnModified(TurmaTableMap::COL_SQ_PESSOA)) {
            $criteria->add(TurmaTableMap::COL_SQ_PESSOA, $this->sq_pessoa);
        }
        if ($this->isColumnModified(TurmaTableMap::COL_ID_MODALIDADE)) {
            $criteria->add(TurmaTableMap::COL_ID_MODALIDADE, $this->id_modalidade);
        }
    ...
    {
        $criteria = ChildTurmaQuery::create();
        $criteria->add(TurmaTableMap::COL_SQ_TURMA, $this->sq_turma);
    ...
    /**
     * Generic method to set the primary key (sq_turma column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \model\model\Turma (or compatible) type.
    ...
    {
        $copyObj->setHorario($this->getHorario());
        $copyObj->setSqPessoa($this->getSqPessoa());
        $copyObj->setIdModalidade($this->getIdModalidade());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSqTurma(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \model\model\Turma Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildModalidade object.
     *
     * @param  ChildModalidade $v
     * @return $this|\model\model\Turma The current object (for fluent API support)
     * @throws PropelException
     */
    public function setModalidade(ChildModalidade $v = null)
    {
        if ($v === null) {
            $this->setIdModalidade(NULL);
        } else {
            $this->setIdModalidade($v->getIdModalidade());
        }

        $this->aModalidade = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildModalidade object, it will not be re-added.
        if ($v !== null) {
            $v->addTurma($this);
        }
    ...
    /**
     * Get the associated ChildModalidade object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildModalidade The associated ChildModalidade object.
     * @throws PropelException
     */
    public function getModalidade(ConnectionInterface $con = null)
    {
        if ($this->aModalidade === null && ($this->id_modalidade !== null)) {
            $this->aModalidade = ChildModalidadeQuery::create()->findPk($this->id_modalidade, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aModalidade->addTurmas($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setSqPessoa(NULL);
        } else {
            $this->setSqPessoa($v->getSqPessoa());
        }
    ...
    {
        if ($this->aPessoa === null && ($this->sq_pessoa !== null)) {
            $this->aPessoa = ChildPessoaQuery::create()->findPk($this->sq_pessoa, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPessoa->addTurmas($this);
             */
        }
     ...
     * If this ChildTurma is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTurma The current object (for fluent API support)
     */
    public function setAlunoTurmas(Collection $alunoTurmas, ConnectionInterface $con = null)
    {
        ...
        foreach ($alunoTurmasToDelete as $alunoTurmaRemoved) {
            $alunoTurmaRemoved->setTurma(null);
        }
     ...
     * Otherwise if this Turma is new, it will return
     * an empty collection; or if this Turma has previously
     * been saved, it will retrieve related AlunoTurmas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Turma.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildAlunoTurma[] List of ChildAlunoTurma objects
     */
    public function getAlunoTurmasJoinPessoa(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAlunoTurmaQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aModalidade) {
            $this->aModalidade->removeTurma($this);
        }
        if (null !== $this->aPessoa) {
            $this->aPessoa->removeTurma($this);
        }
        $this->sq_turma = null;
        $this->horario = null;
        $this->sq_pessoa = null;
    ...
    {
        return (string) $this->exportTo(TurmaTableMap::DEFAULT_STRING_FORMAT);
    }
