...
/**
 * Base class that represents a row from the 'modalidade' table.
 *
 * 
 *
 * @package    propel.generator.model.model.Base
 */
abstract class Modalidade implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\model\\model\\Map\\ModalidadeTableMap';
    ...
    /**
     * Initializes internal state of model\model\Base\Modalidade object.
     */
    ...
    /**
     * Compares this with another <code>Modalidade</code> instance.  If
     * <code>obj</code> is an instance of <code>Modalidade</code>, delegates to
     * <code>equals(Modalidade)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Modalidade The current object, for fluid interface
     */
     ...
     * @return $this|\model\model\Modalidade The current object (for fluent API support)
     */
    public function setIdModalidade($v)
    {
        ...
        if ($this->id_modalidade !== $v) {
            ...
            $this->modifiedColumns[ModalidadeTableMap::COL_ID_MODALIDADE] = true;
        }
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[ModalidadeTableMap::COL_DESCRICAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ModalidadeTableMap::translateFieldName('IdModalidade', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_modalidade = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ModalidadeTableMap::translateFieldName('Descricao', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ModalidadeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\model\\model\\Modalidade'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildModalidadeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Modalidade::setDeleted()
     * @see Modalidade::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildModalidadeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ModalidadeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ModalidadeTableMap::COL_ID_MODALIDADE)) {
            $modifiedColumns[':p' . $index++]  = 'ID_MODALIDADE';
        }
        if ($this->isColumnModified(ModalidadeTableMap::COL_DESCRICAO)) {
            $modifiedColumns[':p' . $index++]  = 'DESCRICAO';
        }

        $sql = sprintf(
            'INSERT INTO modalidade (%s) VALUES (%s)',
    ...
    {
        $pos = ModalidadeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Modalidade'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Modalidade'][$this->hashCode()] = true;
        $keys = ModalidadeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdModalidade(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\model\model\Modalidade
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdModalidade($arr[$keys[0]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\model\model\Modalidade The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ModalidadeTableMap::COL_ID_MODALIDADE)) {
            $criteria->add(ModalidadeTableMap::COL_ID_MODALIDADE, $this->id_modalidade);
        }
        if ($this->isColumnModified(ModalidadeTableMap::COL_DESCRICAO)) {
            $criteria->add(ModalidadeTableMap::COL_DESCRICAO, $this->descricao);
        }
    ...
    {
        $criteria = ChildModalidadeQuery::create();
        $criteria->add(ModalidadeTableMap::COL_ID_MODALIDADE, $this->id_modalidade);
    ...
    {
        $validPk = null !== $this->getIdModalidade();
    ...
    /**
     * Generic method to set the primary key (id_modalidade column).
     *
    ...
    {
        return null === $this->getIdModalidade();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \model\model\Modalidade (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \model\model\Modalidade Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildModalidade is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildModalidade The current object (for fluent API support)
     */
    public function setTurmas(Collection $turmas, ConnectionInterface $con = null)
    {
        ...
        foreach ($turmasToDelete as $turmaRemoved) {
            $turmaRemoved->setModalidade(null);
        }
     ...
     * Otherwise if this Modalidade is new, it will return
     * an empty collection; or if this Modalidade has previously
     * been saved, it will retrieve related Turmas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Modalidade.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTurma[] List of ChildTurma objects
     */
    public function getTurmasJoinPessoa(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTurmaQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ModalidadeTableMap::DEFAULT_STRING_FORMAT);
    }
